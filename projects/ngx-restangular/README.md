# @brakebein/ngx-restangular

ngx-restangular is an Angular 2+ service that simplifies common GET, POST, DELETE, and UPDATE requests with a minimum of client code.
It's a perfect fit for any WebApp that consumes data from a RESTful API.

This is forked version of [2muchcoffeecom/ngx-restangular](https://github.com/2muchcoffeecom/ngx-restangular).
It has been upgraded for Angular v12+.
Some interfaces and type declarations have been added to better support development process.
